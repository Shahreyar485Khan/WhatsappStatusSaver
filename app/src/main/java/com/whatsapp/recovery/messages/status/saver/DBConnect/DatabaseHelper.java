package com.whatsapp.recovery.messages.status.saver.DBConnect;
...
//            Log.d("tagg", ""+cursor.getString(1));
    ...
    public Cursor searchNamebyId(int id ){
        ...
        Cursor cursor = db.query(DatabaseHelper.TABLE_NAME,
                columns,
                DatabaseHelper.COL_1+" LIKE '"+id+"%'", null, null, null, null);
 ...
 /*   public boolean updateData(String id,String name,String surname,String marks) {
    ...
    public Integer deleteDataByTitle (String title) {
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(TABLE_NAME, "NAME = ?",new String[] {title});
    }
